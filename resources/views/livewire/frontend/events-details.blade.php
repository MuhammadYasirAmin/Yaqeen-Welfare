...
@section('activeEventDetails', 'active')
                ...
                <div class="widget-area">
                    ...
                    <div class="information widget-item">
                        ...
                        <ul>
                            ...
                            <li>
                                <span>Location:</span>
                                <a href="javascript:void(0);">6B, Helvetica street, Jordan</a>
                            </li>
                            <li>
                                <span>Phone:</span>
                            ...
                            <li>
                                <span>Email:</span>
                                <a href="/cdn-cgi/l/email-protection#2a424f4646456a4c43444e4504494547"><span
                                        class="__cf_email__"
                                        data-cfemail="d7bfb2bbbbb897b1beb9b3b8f9b4b8ba">[email&#160;protected]</span></a>
                            </li>
                        </ul>
                    </div>
