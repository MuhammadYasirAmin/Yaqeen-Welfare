                    ...
                    <div class="col-lg-6">
                        <div class="banner-content">
                            ...
                            <div class="banner-btn-area">
                                <a class="common-btn banner-btn" href="javascript:void(0);">Get Start A Fundraising</a>
                                <a class="common-btn" href="javascript:void(0);">Donate Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4">
                <div class="dream-item">
                    <h3>
                        <a href="{{ route('frontend.alldonations') }}">Over 20M+ people around the world is having good life because of
                            Yaqeen Welfare</a>
                    </h3>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="dream-item">
                    <h3>
                        <a href="{{ route('frontend.alldonations') }}">We are supporting the poor and homeless people by providing
                            food</a>
                    </h3>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="dream-item">
                    <h3>
                        <a href="{{ route('frontend.alldonations') }}">First time a non- profitable organization is fighting against the
                            poverty</a>
                    </h3>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="dream-item">
                    <h3>
                        <a href="{{ route('frontend.alldonations') }}">Over 1200+ volunteer working for Yaqeen Welfare around the
                            world</a>
                    </h3>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="dream-item">
                    <h3>
                        <a href="{{ route('frontend.alldonations') }}">Hands move to support in Yemen combat covid-19 by donating face
                            masks</a>
                    </h3>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="dream-item">
                    <h3>
                        <a href="{{ route('frontend.alldonations') }}">This project seeks to build houses for reduce their suffering allow
                            them to live</a>
                    </h3>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p>
            ...
            <div class="col-lg-6">
                <div class="about-content">
                    ...
                    <div class="about-btn-area">
                        <a class="common-btn about-btn" href="javascript:void(0);">Get Start A Fundraising</a>
                        <a class="common-btn" href="javascript:void(0);">Read More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4">
                <div class="feature-item">
                    ...
                    <p>Contrary to popular belief, Lorem Ipsum is not simply rom text. Contrary to popular belief is
                        not simply.</p>
                    <a class="feature-btn" href="javascript:void(0);">Join Now</a>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
            ...
            <div class="col-sm-6 offset-sm-3 offset-lg-0 col-lg-4">
                <div class="feature-item three">
                    ...
                    <h3>
                        <a href="javascript:void(0);">Show your love</a>
                    </h3>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply rom text. Contrary to popular belief is
                        not simply.</p>
                    <a class="feature-btn" href="javascript:void(0);">Join Now</a>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="event-item-right">
                    ...
                    <h3>
                        <a href="{{ route('frontend.eventdetails') }}">Challenge is right for you</a>
                    </h3>
                    <ul>
                        <li>
                            <i class="icofont-stopwatch"></i>
                ...
                <div class="event-item-right">
                    ...
                    <h3>
                        <a href="{{ route('frontend.eventdetails') }}">Fundraising is going</a>
                    </h3>
                    <ul>
                        <li>
                            <i class="icofont-stopwatch"></i>
                ...
                <div class="event-item-right">
                    ...
                    <h3>
                        <a href="{{ route('frontend.eventdetails') }}">Bowling for a cause</a>
                    </h3>
                    <ul>
                        <li>
                            <i class="icofont-stopwatch"></i>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="blog-item">
                    ...
                    <div class="bottom">
                        ...
                        <h3>
                            <a href="{{ route('frontend.blogdetails') }}">Donate for nutration less poor people</a>
                        </h3>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet cupiditate sit ducimus
                            dolor laudantium distinction</p>
                        <a class="blog-btn" href="{{ route('frontend.blogdetails') }}">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="blog-item">
                    ...
                    <div class="bottom">
                        ...
                        <h3>
                            <a href="{{ route('frontend.blogdetails') }}">Charity meetup in Berline next year</a>
                        </h3>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet cupiditate sit ducimus
                            dolor laudantium distinction</p>
                        <a class="blog-btn" href="{{ route('frontend.blogdetails') }}">Read More</a>
            ...
            <div class="col-sm-6 offset-sm-3 offset-lg-0 col-lg-4">
                <div class="blog-item">
                    ...
                    <div class="bottom">
                        ...
                        <h3>
                            <a href="{{ route('frontend.blogdetails') }}">Donate for the poor people to help them</a>
                        </h3>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet cupiditate sit ducimus
                            dolor laudantium distinction</p>
                        <a class="blog-btn" href="{{ route('frontend.blogdetails') }}">Read More</a>
