        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4">
                <div class="dream-item">
                    <h3>
                        <a href="{{ route('frontend.alldonations') }}">Over 20M+ people around the world is having good life because of Yaqeen
                            Welfare</a>
                    </h3>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="dream-item">
                    <h3>
                        <a href="{{ route('frontend.alldonations') }}">We are supporting the poor and homeless people by providing food</a>
                    </h3>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="dream-item">
                    <h3>
                        <a href="{{ route('frontend.alldonations') }}">Over 1200+ volunteer working for Yaqeen Welfare around the world</a>
                    </h3>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="benefit-img">
                    <img src="{{ asset('assets/img/benefit-main1.jpg') }}" alt="Benefit">
                    <img src="{{ asset('assets/img/benefit-shape1.png') }}" alt="Benefit">
